class NeovimNightly < Formula
  ...
  version "v0.12.0-dev-1078+g088ba835ed"

  if Hardware::CPU.arm?
    url "https://github.com/neovim/neovim/releases/download/nightly/nvim-macos-arm64.tar.gz"
    sha256 "b57c1272b7be48bf5257e39512561d92f75ad0784eacf9979ebdfed8d9692e32"
  else
    url "https://github.com/neovim/neovim/releases/download/nightly/nvim-macos-x86_64.tar.gz"
    sha256 "b3a026953d8c66c5191490a258321879c2edf16be2a48e1ef2c7f64314896f73"
  end
